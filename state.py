# Script to check the power STATE (on/off) of a Kasa Smart Plug that uses KLAP LV2 encryption.
    ...
    try: # Interact with the connected plug.
        ...
        if plug.is_on == True:
          ...
          state_after = 'Off'
            ...
            state_after = 'Error'
        msgout = f"Kasa STATE called. The power state of the Kasa plug is '{state_after}'. Updated custom variable '{COMP_VAR}' in Bitfocus Companion.'"
